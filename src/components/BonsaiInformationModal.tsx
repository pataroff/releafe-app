                        ...
                        >
                            ...
                            {informatiegidsIndex == 3 && (
                                <>
                                    ...
                                    <Image source={require('../../assets/images/bonsai_points_achievements_information_icons.png')} style={{ objectFit: 'contain', alignSelf: 'center', width: windowWidth / 1.15, height: 160 }} />
                                </>
                            )}
                        </View>
                        {/*Close out Button*/}
